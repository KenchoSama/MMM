...
func _on_player_lost():
	...
	$"UI Layer/Control/PauseMenu/BoundingBox/Panel/MuteButton/AudioStreamPlayer".stop()
...
func _on_pre_game():
	...
	$"UI Layer/Control/PauseMenu/BoundingBox/Panel/MuteButton/AudioStreamPlayer".play(0)
